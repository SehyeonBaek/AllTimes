...
<html lang="ko">
  ...
  <!--Bootstrap core CSS-->
    ...
    <![endif]-->
      ...
      <link rel="${pageContext.request.contextPath}/stylesheet" type="text/css" href="resources/css/font-awesome.min.css" />
      <link href="${pageContext.request.contextPath}/resources/css/lightbox.min.css" rel="stylesheet">
      <link rel="${pageContext.request.contextPath}/stylesheet" type="text/css" href="resources/css/loaders.css"/>
...
<header>
    ...
    <div class="container">
        ...
        <div class="col-md-6 col-lg-4">
    			<h1>All times<small>Get the latest News</small></h1>
		</div>
        <div class="col-md-6 col-lg-5 offset-lg-3 admin-bar hidden-sm-down">
                <nav class="nav nav-inline"> <a href="#" class="nav-link"><span class="ping"></span><i class="fa fa-envelope-o"></i></a> <a href="#" class="nav-link"><i class="fa fa-bell-o"></i></a> <a href="MemberModifyForm" class="nav-link">Bruce Wayne <img class="img-fluid img-circle" src="resources/img/admin-bg.jpg"></a> </nav>
              </div>
      </div>
          </div>
  </div>
...
<section class="banner-sec">
    ...
    <div class="row">
            <div class="col-md-3">
        <div class="card"> <img class="img-fluid" src="resources/img/media-1.jpg" alt="">
        ...
        <div class="card"> <img class="img-fluid" src="resources/img/media-3.jpg" alt="">
            ...
            <div class="col-md-3">
        <div class="card"> <img class="img-fluid" src="resources/img/media-2.jpg" alt="">
        ...
        <div class="card"> <img class="img-fluid" src="resources/img/media-4.jpg" alt="">
                <div class="card-img-overlay"> <span class="tag tag-pill tag-danger">News</span> </div>
                <div class="card-block">
            <div class="news-title">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
            ...
            <div class="carousel-item active">
                ...
                <div class="news-media"><img class="img-fluid" src="resources/img/media-5.jpg" alt=""></div>
                <div class="news-title">
            ...
            <div class="carousel-item">
                    <div class="news-block">
                <div class="news-media"><img class="img-fluid" src="resources/img/media-6.jpg" alt=""></div>
                <div class="news-title">
            ...
            <div class="carousel-item">
                    <div class="news-block">
                <div class="news-media"><img class="img-fluid" src="resources/img/media-7.jpg" alt=""></div>
                <div class="news-title">
...
<section class="section-01">
    ...
    <div class="row">
        ...
        <div class="row">
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="resources/img/media-9.jpg" alt="">
                    <div class="card-block">
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="resources/img/media-10.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="resources/img/media-7.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="resources/img/media-8.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
        ...
        <div class="tab-content sidebar-tabing">
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="resources/img/media-1.jpg" alt=""> </a>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="resources/img/media-2.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Obamacare Appears to Be Making People Healthier</a></h2>
                      </div>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="resources/img/media-3.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Key Republicans sign letter warning against candidate</a></h2>
                      </div>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="resources/img/media-4.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Key Republicans sign letter warning against candidate</a></h2>
                      </div>
...
<section class="video-gallery-sec">
    ...
    <div class="row">
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-2.jpg" data-lightbox="media-2" data-title="An Alternative Form of Mental Health Care Gains a Foothold"><img class="img-fluid example-image" src="resources/img/media-2.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>12</span></div>
                <h2 class=" title-small">An Alternative Form of Mental Health Care Gains a Foothold</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-3.jpg" data-lightbox="media-3" data-title="Delta passengers got pizza delivered to the plane"><img class="img-fluid" src="resources/img/media-3.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>17</span></div>
                <h2 class=" title-small">Delta passengers got pizza delivered to the plane</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-4.jpg" data-lightbox="media-4" data-title="He took Bolt's record - can he?"><img class="img-fluid" src="resources/img/media-4.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>06</span></div>
            ...
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-5.jpg" data-lightbox="media-5" data-title="Minorities Suffer From Unequal Pain Treatment"><img class="img-fluid" src="resources/img/media-5.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>09</span></div>
                <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                <div> </div>
              </div>
      </div>
    ...
    <div class="row">
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-6.jpg" data-lightbox="media-6" data-title="Minorities Suffer From Unequal Pain Treatment"><img class="img-fluid" src="resources/img/media-6.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>10</span></div>
                <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-7.jpg" data-lightbox="media-7" data-title="Delta passengers got pizza delivered to the plane"><img class="img-fluid" src="resources/img/media-7.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>11</span></div>
                <h2 class=" title-small">Delta passengers got pizza delivered to the plane</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-8.jpg" data-lightbox="media-8" data-title="He took Bolt's record - can he?"><img class="img-fluid" src="resources/img/media-8.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>05</span></div>
                <h2 class=" title-small">He took Bolt's record - can he?</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="resources/img/media-9.jpg" data-lightbox="media-9" data-title="Best moments in travel"><img class="img-fluid" src="resources/img/media-9.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>15</span></div>
...
<div class="sub-footer">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
        ...
        <div class="carousel-item active"> <img class="img-fluid" src="resources/img/footer-col-1.jpg">
        ...
        <div class="carousel-item"> <img class="img-fluid" src="resources/img/footer-col-2.jpg">
                <div class="carousel-caption">
            <div class="news-title">
        ...
        <div class="carousel-item"> <img class="img-fluid" src="resources/img/footer-col-3.jpg">
                <div class="carousel-caption">
            <div class="news-title">
                    <h2 class=" title-large"><a href="#">Key Republican Senator Says She Will Not Vote for former president!</a></h2>
                  </div>
        ...
        <div class="carousel-item"> <img class="img-fluid" src="resources/img/footer-col-4.jpg">
                <div class="carousel-caption">
            <div class="news-title">
                    <h2 class=" title-large"><a href="#">An Alternative Form of Mental Health Care Gains a Foothold</a></h2>
                  </div>
        ...
        <div class="carousel-item"> <img class="img-fluid" src="resources/img/footer-col-5.jpg">
                <div class="carousel-caption">
            <div class="news-title">
...
<script src="${pageContext.request.contextPath}/resources/js/core.js?val=1"></script> 
